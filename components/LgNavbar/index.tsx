...
export default function Navbar() {
  ...
  return (
    <div
      className="duraiton-300 fixed top-2 left-0 z-20 w-screen transition-all ease-in"
      id="nav-wrapper"
    >
      <nav className="mx-auto flex w-container flex-row justify-between py-4 px-4">
